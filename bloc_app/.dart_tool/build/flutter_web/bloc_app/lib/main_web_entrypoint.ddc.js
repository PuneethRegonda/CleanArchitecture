define(['dart_sdk', 'packages/bloc_app/main'], function(dart_sdk, packages__bloc_app__main) {
  'use strict';
  ...
  const main = packages__bloc_app__main.main;
  ...
  dart.trackLibraries("packages/bloc_app/main_web_entrypoint", {
    "package:bloc_app/main_web_entrypoint.dart": main_web_entrypoint
  }, {
